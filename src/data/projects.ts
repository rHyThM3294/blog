...
import morningFarmCover from '@/assets/images/covers/morning-farm.webp'
import bookshelfCover from '@/assets/images/covers/bookshelf.webp'
import laborSiteCover from '@/assets/images/covers/labor-site.webp'
import aiChatHubCover from '@/assets/images/covers/ai-chat-hub.webp'
...
export const projects: Project[] = [
  {
    ...
    content: `這個專案最大的挑戰，是在頁面數量不斷增加的情況下，思考「元件的邊界應該在哪裡」。
...
整體架構以「未來可繼續擴充」為目標，盡量讓每次新增頁面或功能時，不需要動到原有元件的核心邏輯。`,
  ...
  },
  {
    ...
    slug: 'bookshelf',
    summary:
      '串接 Google Books API 的個人書架應用，支援書籍搜尋、分頁載入與想讀／在讀／已讀三種書架管理。',
    description:
    ...
    content: `這個專案的核心挑戰是「在沒有複雜狀態管理套件的情況下，如何讓 Custom Hooks 承擔所有邏輯重量」。
...
內容頁面涵蓋勞保六大給付完整說明、勞退新舊制比較，以及針對接案族、外送員、兼職族與外籍工作者的特殊族群指南，每個頁面都有對應的 FAQ。`,
  ...
  },
  {
    ...
    content: `這個專案的核心目標是「盡量還原真實 AI 產品的互動體驗」，從串流輸出、多聊天室管理到細節 UI，都是學習重點。
