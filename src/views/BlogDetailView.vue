      ...
      >
        <article class="articleCard">
          <div class="articleContent">
            <div v-if="post.content" class="articleText markdownBody" v-html="htmlContent"></div>
            <p v-else class="articleText">目前尚未補上完整文章內容，之後會持續整理。</p>
          </div>
        </article>
      </BaseSection>
    </template>
    <BaseSection v-else class="emptySection" compact>
      <EmptyState title="找不到這篇文章" description="可能是網址有誤，或這篇文章資料目前不存在。">
        <template #action>
